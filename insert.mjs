...
const {
    ...
    IdentificationCode,
    ContactDetails: { ContactFunctionCode, Name: ContactName, TelephoneNumber, FAXNumber, Email },
  } = data[0].SubmitterInformation;
...
//        try {
//            connection.query('INSERT INTO submitter SET ?', data[i].SubmitterInformation, (error, results) => {
